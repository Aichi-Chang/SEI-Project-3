...
const cultureFData = (user) => {
  ...
  },
  {
    ...
    year: 1997,
    image: 'https://m.media-amazon.com/images/M/MV5BOTI0MzcxMTYtZDVkMy00NjY1LTgyMTYtZmUxN2M3NmQ2NWJhXkEyXkFqcGdeQXVyMTQxNzMzNDI@._V1_SY1000_CR0,0,655,1000_AL_.jpg',
    summary: 'Biased here. Not everybody loves this movie, but it\'s on the top of my watch list purely because of the rawness and emotion of the scenes with long strips of conversation. Ben Affleck and Matt Damon\'s screenwriting debut, which they co-won an Oscar for. If only Titanic did not completely eclipse this movie in 1997, this movie would have won much more than the 4 academy awards than it did. It\'s touching tale of a wayward young man who struggles to find his identity, living in a world where he can solve any problem, except the one brewing deep within himself, until one day he meets his soulmate who opens his mind and his heart.',
    rating: 5,
    user: user[0],
    comments: []
  },
...

  {
    ...
    year: 2009,
    image: 'https://m.media-amazon.com/images/M/MV5BOTJiNDEzOWYtMTVjOC00ZjlmLWE0NGMtZmE1OWVmZDQ2OWJhXkEyXkFqcGdeQXVyNTIzOTk5ODM@._V1_SY1000_SX675_AL_.jpg',
    summary: 'A fun, engrossing, beautifully crafted piece of nonsense, the likes of which we hadn\'t seen in a long, long time. The silliness of the story is marvelously camouflaged with great dialogue and some superb performances. Christoph Waltz must be thinking already about his acceptance speech. What a performance! The civilized monster, polyglot, refined and deadly. He gets us going from the first, sensational scene. Brad Pitt is also wonderful. Was he putting a Mussolinni chin while impersonating (hilariously) an Italian? I thought so. His character\'s name sounds like Aldo Ray and I\'m sure that\'s no accident. The film is full of movie references. Another character is named Fenek, as an homage to his 1970\'s sexpot, Edwige Fenech. What is already one of Tarantino\'s trademarks is his sure step along the most immediately recognisable bits of pop culture. For better or worse this are Tarantino times.',
    rating: 5,
    user: user[0],
    comments: []
  },
...

{
  ...
  summary: 'When we talk about Back to the Future, we have to talk about the whole trilogy. A young man (Michael J. Fox) is accidentally sent thirty years into the past in a time-traveling DeLorean invented by his eccentric scientist-friend, Dr. Emmett Brown (Christopher Lloyd), and must make sure his high-school-age parents unite in order to save his own existence. After over thirty years, this film loses none of its charm, and actually gains respect. The movie has had such a strong impression on everyone, whether they have seen it or not, as it completely permeated pop culture. The script is genius, not only how it parallels 1955 and 1985 (some of the references are dynamite), but how it set the scene for the sequels (despite allegedly not intending to have any). This is just one clever gag after another, and may require repeated viewings to catch them all. A real throwback, and a feel-good masterpiece.',
  rating: 5,
  user: user[0],
  comments: []  
},
{
  ...
  year: 1994,
  image: 'https://m.media-amazon.com/images/M/MV5BYThmYjJhMGItNjlmOC00ZDRiLWEzNjUtZjU4MjA3MzY0MzFmXkEyXkFqcGdeQXVyNTI4MjkwNjA@._V1_SY1000_CR0,0,667,1000_AL_.jpg',
  summary: 'Interview with the Vampire\' is an atmospheric, highly gripping "film involving vampires" - not a "vampire movie". Whilst the latter would describe a film that focuses on its vampirism and might be judged on the sharpness of its fangs, this "film involving vampires" has all the merits of the very best cinema, and at its core is nothing but a fantastic story carried by compelling, believable characters. For those who may not be able to overlook the vampiric content, look again. The vampirism herein is a plot device, a way of presenting characters who cannot die or age or be harmed, so that the philosophical questions of life itself can be explored. But equally, for those who will be interested in the vampiric content, this film presents a rich mythology backed by a trilogy of books, which fleshes out the concept of the vampire in a much deeper way than any other production. The story is propelled by vampires Louis (Pitt) and Lestat (Cruise), each representing a different take on life. Whilst Louis, who began as a depressive wanting to die, thinks of eternity as an extended curse; Lestat, who seems to live every second as it comes, barely even considers the future three minutes hence. Told from Louis\' viewpoint as he struggles to find some meaning in a life he knows will never end, we are taken on a ride across the centuries, as Louis\' outlook and happiness undulate whilst characters and relationships come and go. \'Interview with the Vampire\' explores all of these deep, important issues whilst delivering an incredibly powerful story populated by charismatic characters, haunting and diverse settings and immortal dialogue. Gripping from start to finish, you will be enamoured at the vampire-world opened up to you; and by the end, you are left wondering what choice you would have made, given the one that Lestat never had...',
  rating: 5,
  user: user[0],
  comments: []  
},
{
  title: 'Cast Away',
  year: 2000,
  image: 'https://m.media-amazon.com/images/M/MV5BN2Y5ZTU4YjctMDRmMC00MTg4LWE1M2MtMjk4MzVmOTE4YjkzXkEyXkFqcGdeQXVyNTc1NTQxODI@._V1_.jpg',
...
summary: 'Jurassic Park is a 1993 American science fiction adventure film directed by Steven Spielberg. It\'s the first installment of the Jurassic Park film series, and based on the 1990 novel of the same name by Michael Crichton, with a screenplay written by Crichton and David Koepp. The film centers on the fictional Isla Nublar, an islet located off Central America\'s Pacific Coast, near Costa Rica, where a billionaire philanthropist and a small team of genetic scientists have created a wildlife park of cloned dinosaurs. What can I say about Jurassic Park? It\'s a cult classic and it has a heart. We have a Tyrannosaurus Rex chasing the group, Velociraptors chasing Tim and Lex, after they are reaching the visitor center and they are in inside the main kitchen- my anxiety levels hit the roof wit hthat one. We have a Dilophosaurus killing Nerdy. We also have Triceratops in it and Brachiosaurus... just an all round visually entertaining, thrilling watch.',
rating: 5,
user: user[0],
comments: []  
},
...

{
  ...
  summary:'Some may consider it controversial that Captain Marvel makes it onto our list of movies to watch, given the uninspiring reviews online, but -unpopular opinion- I think the movie carries depth beyond the MCU. It\'s torn the MCU fandomand frankly, hasn\'t been recieved as well as expected for unwarranted reasons. Give Brie Larson a chance! Larson\'s performance portaying a hyped, and well-loved character in the MCU is always going to be met by harsh critics. Captain Marvel is afterall, a much anticipated character, with complicated origin story. There was a lot to fit into this movie, and simply not enough time for the audience to adjust. The installment dates back to the 90\'s, where the audience is introduced to Carol Danvers and a much younger Nick Fury. What an introduction! Danvers becomes one of the universe\'s most powerful heroes when Earth is caught in the middle of a galactic war between two alien races. Lot\'s of 90\'s pop culture references, music, and grundge fashion- a welcoming wave of nostaligia washed over me while watching Carol kick ass. Ignoring the crituque of weeding through social justice messages, this was a fun movie, with a leading lady and 0 love interests- easily passing the bechtel test. We see Carol eventually tipping the scales for our Heros in the fight to save the worlds against Thanos',
  rating: 5,
  user: user[0],
  comments: [] 
},
{
  ...
  summary:'Quite possibly the biggest crossover in cinematic history! What the Russo brothers have a achieved in the last decade is nothing short of spectacular. Endgame takes off where Infinity War left us. And it left us utterly devastated and wondering how our hroes could could possibly get out of this mess. We wondered how the story would go on, what would be the end of Thanos. Avengers Endgame was undoubtedly the most anticipated film of recent years. Normally, the higher the expectation, the higher the probability of disappointment. But this wasn\'t not the case for Endgame. Whatever your expectations were, you probably found the movie has far exceeded them. Is Endgame more successful than Infinity War? Endgame was the finale of phase one and two of the MCU\'s reimagining of our favourate heroes. Avengers Endgame is a great homage to the ten-year history of the Marvel Cinematic Universe. The story highlights the original Avengers team: Iron Man, Captain America, Thor, Hulk, Black Widow and Hawkeye who are at the center of the devastating events unravelling. Of course there are many characters that play an important role in the story outside the original Avengers team- shoutout ot my fave, Ant Man! not just providing welll-executed comedic relief, but a plot device to save and undo what Thanos has done. Everyone\'s concern was that Captain Marvel, who was included in the Marvel world, overshadowed other heroes. We can say that this certainly did not happen. What is important in this struggle is not how strong you are, but how good you are. This comes to the fore in all areas. In true Marvel fashion, it gives a good message about being a hero and what it means to be a family.',
  rating: 5,
  user: user[0],
  comments: [] 
}
